...
export class Glyf {
  public static parse(data: Uint8Array, offset: number, length: number, font: any): null[] {
    let obj = [];
    for (let g = 0; g < font.maxp!.numGlyphs; g++) { obj.push(null) }
    return obj;
  }
  public static _parseGlyf(font: any, g: number): any {
    let data = font._data;
    ...
    else
    {
      ...
      do {
        ...
        let part: any = { m: { a: 1, b: 0, c: 0, d: 1, tx: 0, ty: 0 }, p1: -1, p2: -1 };
        gl.parts.push(part);
